  ...
  return (
    <div className="min-h-[calc(100vh-200px)]">
      ...
      <div className="page-header"><div className="container">
        ...
        <h1>PDF to Word (DOCX) Online</h1><p>Extract text content from your PDF. Browser-based, private.</p>
      </div></div>
