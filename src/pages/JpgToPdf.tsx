...
export const JpgToPdf = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-200px)]">
      <PageSeo title="JPG to PDF Online – Free & Private" description="Convert JPG images to PDF in your browser. No uploads, 100% private." faqItems={[{ question: 'Can I convert multiple images?', answer: 'Yes. Select multiple files to create a multi-page PDF.' }, { question: 'Is quality preserved?', answer: 'Images are embedded at their original resolution.' }]} />
      <div className="page-header"><div className="container">
        ...
        <h1>JPG to PDF Online</h1><p>Convert JPG images to PDF instantly in your browser.</p>
      </div></div>
      <div className="container pb-12"><div className="max-w-2xl mx-auto">
        <div className="bg-card border border-border rounded-2xl p-6 md:p-8 shadow-sm">
          <label className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-border rounded-xl cursor-pointer hover:bg-muted transition-colors">
            ...
            <span className="text-sm text-[var(--text-muted)]">Click to select JPG files</span>
            <input type="file" accept=".jpg,.jpeg" multiple className="hidden" onChange={handleFiles} />
          </label>
          {files.length > 0 && (
