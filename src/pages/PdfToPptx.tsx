...
export const PdfToPptx = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-200px)]">
      <PageSeo title="Extract PDF Text for Slides – Free & Private" description="Extract PDF text into a plain text file you can reuse in slides. Browser-based and private." />
